...
padding:'32px 24px 40px',position:'relative',overflow:'hidden',fontFamily:'var(--font-body)'
}},
...
React.createElement('div',{style:{position:'relative',maxWidth:720,margin:'0 auto',textAlign:'center'}},
React.createElement('img',{src:'assets/logos/logo-white-orange.png',alt:'TCSB',style:{height:56,objectFit:'contain',marginBottom:24}}),
