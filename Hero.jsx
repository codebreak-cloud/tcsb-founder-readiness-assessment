function Hero(){
const {Button,Icon}=window.TCSBDesignSystem_000d09;
...
React.createElement('img',{src:'assets/logos/logo-white-orange.png',alt:'TCSB',style:{position:'absolute',top:24,left:24,height:72,objectFit:'contain'}}),
React.createElement('div',{style:{position:'absolute',top:24,right:24}},
React.createElement(Icon,{name:'dots',size:20})
),
